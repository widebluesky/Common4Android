 ...
 * @date 2013-10-08
 */
public class HP_PullToRefreshListView extends ListView implements OnScrollListener {
//    private static final String TAG = "XListView";
    ...
    // -- header view
    private HP_HeaderView mHeaderView;
    ...
    // -- footer view
    private HP_FooterView mFooterView;
    ...
    public HP_PullToRefreshListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initWithContext(Context context) {
        ...
        // init header view
        mHeaderView = new HP_HeaderView(context);
        ...
        // init footer view
        mFooterView = new HP_FooterView(context);
    ...
    public void setPullLoadEnable(boolean enable) {
        ...
        if (!mEnablePullLoad) {
            ...
            mFooterView.show();
            mFooterView.setState(HP_FooterView.STATE_NORMAL);
    ...
    private void updateHeaderHeight(float delta) {
        ...
        if (mEnablePullRefresh && !mPullRefreshing) { // 未处于刷新状态，更新箭头
            if (mHeaderView.getVisiableHeight() > mHeaderViewHeight) {
                mHeaderView.setState(HP_HeaderView.STATE_READY);
            } else {
                mHeaderView.setState(HP_HeaderView.STATE_NORMAL);
            }
        }
    ...
    private void updateFooterHeight(float delta) {
        ...
        if (mEnablePullLoad && !mPullLoading) {
            if (height > PULL_LOAD_MORE_DELTA) { // height enough to invoke load
                // more.
                mFooterView.setState(HP_FooterView.STATE_READY);
            } else {
                mFooterView.setState(HP_FooterView.STATE_NORMAL);
            }
        }
    ...
    private void startLoadMore() {
        mPullLoading = true;
        mFooterView.setState(HP_FooterView.STATE_LOADING);
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (getFirstVisiblePosition() == 0) {
                    ...
                    if (mEnablePullRefresh && mHeaderView.getVisiableHeight() > mHeaderViewHeight && !mPullRefreshing) {
                        ...
                        mHeaderView.setState(HP_HeaderView.STATE_REFRESHING);
                        if (mListViewListener != null) {
