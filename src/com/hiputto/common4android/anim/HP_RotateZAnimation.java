package com.hiputto.common4android.anim;
...
public class HP_RotateZAnimation extends Animation {
	...
	public HP_RotateZAnimation(float fromDegree, float toDegree, float centerX,
			float centerY) {
